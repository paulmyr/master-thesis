...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{An AdEx Channel for Jaxley}\label{sec:results:verification}
...
\subsubsection{Runtime Comparison}\label{sec:results:performance}

% Loss-analysis figures (6.2) sourced here so they float onto consecutive pages starting where 6.2 begins
\begin{figure*}[t]
  \begin{center}
...
\subsubsection{Surrogate Channel Verification}\label{sec:results:verification:surrogate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Loss Function Analysis}\label{sec:results:landscape}
...
\subsubsection{Shared structure across losses}\label{sec:results:landscape:shared}
...
\paragraph*{Gradient magnitude asymmetry between parameters}
...
\subsubsection{Mean Squared Error: the non-spiking attractor}\label{sec:results:landscape:mse}
...
\subsubsection{Guarino: feature artefacts everywhere}\label{sec:results:landscape:guarino}
...
\subsubsection{Van Rossum: a smoother loss, still chaotic gradient}\label{sec:results:landscape:vanrossum}
...
\paragraph*{Surrogate-family dependence}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Parameter Recovery}\label{sec:results:training}
...
\subsubsection{A Worked Example: Recovering a Tonic AdEx Cell}\label{sec:results:positive-example}
...
% \subsubsection{A worked example: fitting an IDthresh recording}\label{sec:results:real-singletrace}
%
...
\subsubsection{Recovery-Radius Benchmark}\label{sec:results:baseline}
...
\paragraph{Headline result: success vs.\ perturbation}
...
Fourth, the two Nelder--Mead variants are indistinguishable: \texttt{nm\_guarino} (soft features) and \texttt{nm\_guarino\_hard} (exact features) report identical $\delta_{50}=0.8$ and median $\Gamma_{0.05}=+1.00$ on every scenario, with per-direction outcomes differing by at most one direction out of 30.

\paragraph{Recovery radii}
...
\paragraph{What the benchmark does not measure}
...
\subsubsection{Subthreshold Recovery: Gradient Descent Without Spikes}\label{sec:results:subthreshold}
